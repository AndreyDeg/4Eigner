namespace View_WinAPI.WinAPI
{
	...
	public enum SM
	{
		...
		DBCSENABLED = 42,
		CMOUSEBUTTONS = 43,
		//CXFIXEDFRAME = SM_CXDLGFRAME,  /* ;win40 name change */
		//CYFIXEDFRAME = SM_CYDLGFRAME,  /* ;win40 name change */
		//CXSIZEFRAME = SM_CXFRAME,     /* ;win40 name change */
		//CYSIZEFRAME = SM_CYFRAME,     /* ;win40 name change */
		SECURE = 44,
		CXEDGE = 45,
		CYEDGE = 46,
		CXMINSPACING = 47,
